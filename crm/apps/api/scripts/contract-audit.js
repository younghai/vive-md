...
function parseOpenApi(pathText) {
...
function normalize(pathWithPlaceholders) {
...
const appRoutes = new Set((app.routes || []).map((r) => `${r.method.toUpperCase()} ${r.path}`));
